...
Handles the TLS connection and log shipping to the central collector VM.
LogAgent uses this to send batched events every N seconds.

Designed to be resilient - buffers events locally if the connection
drops and retries automatically.
"""
